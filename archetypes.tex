...
\section{Les archétypes, cas théorique : le dataset
toy}\label{les-archuxe9types-cas-thuxe9orique-le-dataset-toy}
...
archétypes, dans un ensemble d'observations multivariées. La combinaison
convexe de ces archétypes permet de représenter les observations.
...
On relie les archétypes entre eux par des segments. Les points à
l'intérieur de l'enveloppe convexe sont une combinaison des 3
archétypes. Ceux à l'extérieur, aussi appelé bruit, doivent être
projetés sur les segments qui relient les archétypes entre eux. Pour
avoir un bruit égale à 0, il faudrait avoir le même nombre d'archétypes
que le nombre de points sur l'enveloppe convexe.
...
\CommentTok{\# nous utilisons la fonction archetypes sur le dataset toy, nous spécifions  }
\CommentTok{\# le nombre d\textquotesingle{}archetypes voulu à 3}
...
\caption{\label{tab:unnamed-chunk-4}Matrice de coordonnées}\\
\toprule
\cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{}}} & \cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{x}}} & \cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{y}}}\\
\midrule
\textcolor{gray}{\textbf{{}[1,]}} & 18.832121 & 18.623102\\
\textcolor{gray}{\textbf{{}[2,]}} & 14.204922 & 2.239856\\
\textcolor{gray}{\textbf{{}[3,]}} & 2.872474 & 10.197810\\
\bottomrule
\end{longtable}
...
\begin{longtable}[t]{>{}lrr}
\caption{\label{tab:unnamed-chunk-7}Matrice de coordonnées}\\
\toprule
\cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{}}} & \cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{x}}} & \cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{y}}}\\
\midrule
\textcolor{gray}{\textbf{{}[1,]}} & 19.894904 & 17.767205\\
\textcolor{gray}{\textbf{{}[2,]}} & 2.860161 & 9.941252\\
\textcolor{gray}{\textbf{{}[3,]}} & 15.500106 & 18.779746\\
\textcolor{gray}{\textbf{{}[4,]}} & 13.842473 & 2.218635\\
\bottomrule
\end{longtable}
...
\caption{\label{tab:unnamed-chunk-12}Matrice RGB}\\
\toprule
\cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{}}} & \cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{R}}} & \cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{G}}} & \cellcolor[HTML]{3498db}{\textcolor{white}{\textbf{B}}}\\
\midrule
\textcolor{gray}{\textbf{\cellcolor{gray!10}{{}[1,]}}} & \cellcolor{gray!10}{0.25806630} & \cellcolor{gray!10}{0.41519520} & \cellcolor{gray!10}{0.79029619}\\
\textcolor{gray}{\textbf{{}[2,]}} & 0.00001404 & 0.00001697 & 0.00002024\\
\textcolor{gray}{\textbf{\cellcolor{gray!10}{{}[3,]}}} & \cellcolor{gray!10}{0.99752070} & \cellcolor{gray!10}{0.95105560} & \cellcolor{gray!10}{0.58987067}\\
\bottomrule
\end{longtable}
...
\] avec \(Z\) la matrice des archétypes et \(\alpha\) les paramètres qui
...
Nous obtenons les valeurs \(\alpha\) grâce au paramètre alphas de
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{image\_proj }\OtherTok{\textless{}{-}}\NormalTok{ df\_proj }\SpecialCharTok{|\textgreater{}} \FunctionTok{pivot\_longer}\NormalTok{( }\AttributeTok{cols =} \FunctionTok{c}\NormalTok{(}\StringTok{"R"}\NormalTok{,}\StringTok{"G"}\NormalTok{,}\StringTok{"B"}\NormalTok{), }
                                       \AttributeTok{names\_to =} \StringTok{"canal"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"value"}\NormalTok{) }\SpecialCharTok{|\textgreater{}} 
...
\subsection{Trouver les alphas pour l'ensemble des 3 millions de
...
Cette fonction permet de recalculer la combinaison d'\(\alpha\) qui
permet la projection des pixels sur le plan créé par nos 3 archétypes.
Ensuite nous recalculons les différentes matrices pour obtenir l'image
finale.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{image\_proj }\OtherTok{\textless{}{-}}\NormalTok{ X\_tilde }\SpecialCharTok{|\textgreater{}} \FunctionTok{pivot\_longer}\NormalTok{( }\AttributeTok{cols =} \FunctionTok{c}\NormalTok{(}\StringTok{"R"}\NormalTok{,}\StringTok{"G"}\NormalTok{,}\StringTok{"B"}\NormalTok{), }\AttributeTok{names\_to =} \StringTok{"canal"}\NormalTok{,}
...
\subsection{Avec 2 archétypes}\label{avec-2-archuxe9types}
