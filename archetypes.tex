...
\section{Les archetypes}\label{les-archetypes}
...
\subsection{Archétypes théoriques}\label{archuxe9types-thuxe9oriques}
...
\pandocbounded{\includegraphics[keepaspectratio]{archetypes_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
On peut maintenant les représenter dans le plan avec les autres
observations :

\pandocbounded{\includegraphics[keepaspectratio]{archetypes_files/figure-pdf/unnamed-chunk-6-1.pdf}}

Maintenant on peut visualiser les observations qui sont dans l'enveloppe
convexe :

\pandocbounded{\includegraphics[keepaspectratio]{archetypes_files/figure-pdf/unnamed-chunk-7-1.pdf}}

On peut essayer avec un nombre d'archetypes arbitrairement plus grand.
Avec 4 archetypes :
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#voici le nombre d\textquotesingle{}itération pour obtenir le plus petit RSS}
...
\pandocbounded{\includegraphics[keepaspectratio]{archetypes_files/figure-pdf/unnamed-chunk-9-1.pdf}}

\subsection{Les Archétypes : les
couleurs}\label{les-archuxe9types-les-couleurs}
...
\pandocbounded{\includegraphics[keepaspectratio]{archetypes_files/figure-pdf/unnamed-chunk-14-1.pdf}}
...
\begin{verbatim}
1: rss = 0.00182593, improvement = 0.00714016
2: rss = 0.00126494, improvement = 0.00056099
3: rss = 0.00101610, improvement = 0.00024884
4: rss = 0.00087494, improvement = 0.00014116
5: rss = 0.00079509, improvement = 0.00007985
6: rss = 0.00074005, improvement = 0.00005504
7: rss = 0.00071364, improvement = 0.00002641
8: rss = 0.00070744, improvement = 0.00000619
9: rss = 0.00070283, improvement = 0.00000461
10: rss = 0.00069944, improvement = 0.00000339
11: rss = 0.00069665, improvement = 0.00000279
12: rss = 0.00069417, improvement = 0.00000248
13: rss = 0.00069263, improvement = 0.00000154
14: rss = 0.00069349, improvement = -0.00000086
\end{verbatim}
...
\begin{verbatim}
               R           G            B
[1,] 0.254255262 0.397110529 8.695602e-01
[2,] 0.007810608 0.009369472 2.127822e-05
[3,] 0.984325671 0.952951485 5.568649e-01
\end{verbatim}

Maintenant on peut ajouter ces archétypes à la distribution des 50 000
points :

\pandocbounded{\includegraphics[keepaspectratio]{archetypes_files/figure-pdf/unnamed-chunk-17-1.pdf}}
...
\begin{verbatim}
Warning in method(..., k = k[i]): k=5: Error in qr.solve(alphas %*% t(alphas)): matrice 'a' singulière dans solve
\end{verbatim}
...
le plan formé par les 3 archétypes. Celà revient à résoudre une équation
du style X\_proj=alpha*Z avec Z la matrice des archétypes et alpha les
paramètres qui permettent la projection.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{inverse\_Z}\OtherTok{=}\FunctionTok{solve}\NormalTok{(Z)}

\NormalTok{inverse\_Z}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
        [,1]       [,2]       [,3]
R -2.6723381 -312.37208  4.1848668
G  2.2256447  367.30368 -3.4894415
B  0.9149787  -76.40405  0.3699221
\end{verbatim}
...
\NormalTok{s3d }\OtherTok{\textless{}{-}} \FunctionTok{scatterplot3d}\NormalTok{(}
  ...
  \AttributeTok{main       =} \StringTok{"Distribution de 50 000 pixels du tableau projetés dans le plan formé par les archétypes"}
\NormalTok{)}
...
\pandocbounded{\includegraphics[keepaspectratio]{archetypes_files/figure-pdf/unnamed-chunk-25-1.pdf}}
...
Nous essayons avec 500 000 points. Nous supposons que les archétypes
calculés pour 50 000 points sont les mêmes pour 500 000 points.

Nous observons les éléments du tableau qui commencent à ressortir mais
...
\pandocbounded{\includegraphics[keepaspectratio]{archetypes_files/figure-pdf/unnamed-chunk-29-1.pdf}}
